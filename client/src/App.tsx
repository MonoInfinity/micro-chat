...
import { BellIcon, MenuIcon, XIcon, UserIcon, AnnotationIcon } from '@heroicons/react/outline';
    ...
    return (
        <>
            <Disclosure as="header" className="bg-white shadow">
                {({ open }) => (
                    <>
                        <div className="max-w-8xl mx-auto px-2 sm:px-4 lg:divide-y lg:divide-gray-200 lg:px-32">
                            <div className="relative h-16 flex justify-between">
                                <div className="relative z-10 px-2 flex lg:px-0">
                                    <div className="flex-shrink-0 flex items-center">
                                        <span className="text-blue-700 font-bold text-2xl">Mono Chat App</span>
                                    </div>
                                </div>
